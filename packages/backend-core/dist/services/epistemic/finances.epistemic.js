 ...
 */
function computeRevenueEpistemic(totalRevenue, dataCoveragePct) {
 ...
 */
function computeNetResultEpistemic(netResult, revenueEpistemic, totalCosts) {
 ...
 * - >= 0 → KNOWN
 */
function computeRefundsEpistemic(refundsObserved) {
 ...
 */
export function computeFinancesEpistemic(input) {
    const revenue = computeRevenueEpistemic(input.totalRevenue, input.dataCoveragePct);
    const netResult = computeNetResultEpistemic(input.netResult, revenue, input.totalCosts);
