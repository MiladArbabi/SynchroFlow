 ...
 */
const __DEV__ = typeof import.meta !== 'undefined' &&
    import.meta.env?.DEV === true;
export function FT2Row({ children, intent }) {
    ...
    if (__DEV__) {
        items.forEach((child) => {
            if (typeof child === 'object' &&
                ...
                if (!hasSpanProp) {
                    console.warn(`[FT2Row] Child (${componentName}) does not expose a 'span' prop. ` +
    ...
    return (_jsx(Paper, { elevation: 0, "data-ft2-row": true, "data-ft2-intent": intent, sx: {
            display: 'flex',
            flexDirection: 'row',
            /**
             * ROW HEIGHT POLICY
            ...
            return (_jsx(Paper, { elevation: 0, "data-ft2-span": span, "data-ft2-child-type": childType, sx: {
                    display: 'flex',
                    /**
...
//# sourceMappingURL=FT2Row.js.map