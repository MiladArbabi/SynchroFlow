...
export default function OrdersModuleFT2(props) {
    ...
    return (_jsxs(Box, { sx: { p: '24px 40px', minHeight: '100%', bgcolor: 'var(--bg)' }, children: [_jsxs(Box, { sx: { display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', mb: 3 }, children: [_jsxs(Box, { children: [_jsxs(Box, { sx: { display: 'flex', alignItems: 'center', gap: 1, mb: 0.75 }, children: [_jsx(Box, { sx: { width: 6, height: 6, borderRadius: '50%', bgcolor: '#4CAF7A', flexShrink: 0 } }), _jsxs(Typography, { sx: { fontSize: 10, fontWeight: 500, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--ink-4)' }, children: [dayLabel, " \u00B7 Channels live \u00B7 ", syncLabel] })] }), _jsx(Typography, { sx: { fontSize: 26, fontWeight: 700, color: 'var(--ink)', lineHeight: 1.1, letterSpacing: '-0.02em', mb: 0.375 }, children: "Orders" }), _jsx(Typography, { sx: { fontSize: 13, fontWeight: 300, color: 'var(--ink-3)' }, children: constrained > 0
                                ...
                                p: '18px 20px',
                                        ...
                                        color: 'var(--ink-4)',
                                        mb: 1,
                                    }, children: "Today's pulse" }), _jsxs(Typography, { sx: {
                                        fontSize: 24,
                                        fontWeight: 700,
                                        color: aging72 > 0 ? STAGE_COLORS.breached : 'var(--ink)',
                                        lineHeight: 1.1,
                                    }, children: [fmtN(aging72), " breached"] }), _jsx(Typography, { sx: {
                                        fontSize: 12,
                                        fontWeight: 300,
                                        color: 'var(--ink-4)',
                                        mt: 0.5,
                                        mb: 2,
                                    }, children: unprioritizedCriticalCount > 0
                                        ? `${unprioritizedCriticalCount} still need priority`
                                        : 'Critical queue is under control' }), _jsx(Box, { sx: { display: 'grid', gap: 1.15 }, children: pulseRows.map(row => (_jsxs(Box, { children: [_jsxs(Box, { sx: {
                                                    display: 'flex',
                                                    alignItems: 'baseline',
                                                    justifyContent: 'space-between',
                                                    mb: 0.5,
                                                }, children: [_jsx(Typography, { sx: { fontSize: 12.5, fontWeight: 300, color: 'var(--ink-3)' }, children: row.label }), _jsx(Typography, { sx: { fontSize: 12.5, fontWeight: 600, color: 'var(--ink)' }, children: fmtN(row.n) })] }), _jsx(Box, { sx: {
                                                    height: 5,
                                                    borderRadius: '999px',
                                                    overflow: 'hidden',
                                                    bgcolor: 'rgba(255,255,255,0.06)',
                                                        ...
                                                        borderRadius: '999px',
                                                        bgcolor: row.color,
                                                    } }) })] }, row.label))) }), _jsx(Box, { sx: { borderTop: '1px solid var(--rule)', mt: 2, pt: 1.5 }, children: _jsxs(Typography, { sx: { fontSize: 12.5, fontWeight: 300, color: 'var(--ink-4)' }, children: [_jsx(Box, { component: "span", sx: { fontWeight: 600, color: 'var(--ink)' }, children: fmtN(props.orders?.fulfilled) }), ' shipped today · ', _jsx(Box, { component: "span", sx: { fontWeight: 600, color: 'var(--ink)' }, children: fmt$(revenue?.earned) }), ' collected'] }) }), _jsx(Box, { onClick: () => navigate('/orders/flow'), sx: {
                                        display: 'inline-flex',
                                        alignItems: 'center',
