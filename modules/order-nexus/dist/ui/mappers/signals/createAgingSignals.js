 ...
 */
export function createEarlyAgingSignal(snapshot, detectedAt, lifecycle, severity, signalId) {
    return {
        id: signalId,
        severity,
        detectedAt,
 ...
 */
export function createAgingOrdersSignal(snapshot, detectedAt, lifecycle, severity, signalId) {
    const affected = snapshot.aging_48h + snapshot.aging_72h_plus;
    return {
        id: signalId,
        severity,
        detectedAt,
...
//# sourceMappingURL=createAgingSignals.js.map