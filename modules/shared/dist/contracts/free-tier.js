...
export const MODULE_FREE_TIER_POLICIES = {
    ...
    finances: {
        ...
        lockedMessage: 'Financial diagnostics are always available at the diagnostic level on the Free tier.',
        resetPeriod: 'monthly'
    },
    // SKU-OS – 5 SKUs
    'sku-os': {
...
export function computeModuleAccessState(input) {
