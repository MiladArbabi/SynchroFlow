export type ModuleId = 'platform' | 'order-nexus' | 'return-nexus' | 'finances' | 'specter' | 'sku-os' | 'wms' | 'problem-center' | 'suppliers-portal' | 'floor-planning';
export type ReadinessSignalName = string;
export type ReadinessSignalValue = boolean | number | string | null;
export interface ReadinessSignal {
    name: ReadinessSignalName;
    value: ReadinessSignalValue;
}
export type OnboardingTaskCompletionOperator = 'presence' | 'equals' | 'not_equals' | 'gte' | 'lte' | 'gt' | 'lt';
...
export type OnboardingActionType = 'navigate' | 'openModal' | 'openExternal' | 'none';
