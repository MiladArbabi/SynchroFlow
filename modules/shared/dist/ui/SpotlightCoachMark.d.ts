...
export declare function SpotlightCoachMark({ title, body, isDismissed, onDismiss, step, totalSteps, direction, }: SpotlightCoachMarkProps): import("react/jsx-runtime").JSX.Element | null;
export {};
