 ...
 */
export function normalizeRawSession(raw) {
    ...
    if (raw.customerId) {
        ...
        err.code = (PrivacyGuards && PrivacyGuards.PCD_VIOLATION_ERROR) || 'PCD_VIOLATION';
        throw err;
    }
    const normalized = {
        sessionId: uuidv4(),
 ...
 */
export async function ingestRawSession(shopId, raw) {
    // normalize + PCD check
 ...
 */
export function computeSessionMetrics(shopId, days = 7) {
