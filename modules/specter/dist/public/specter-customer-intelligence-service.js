...
exports.createDefaultCustomerSignal = createDefaultCustomerSignal;
function createDefaultCustomerSignal(shopId, hashedCustomerId) {
    return {
        shopId,
        hashedCustomerId,
...
class SpecterCustomerIntelligenceService {
    /**
...
exports.default = SpecterCustomerIntelligenceService;
