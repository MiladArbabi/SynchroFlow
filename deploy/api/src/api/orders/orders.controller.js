...
exports.httpGetOrderDetails = exports.httpGetOrderProfitability = exports.httpGetOrderStatus = exports.httpGetAllOrders = void 0;
 ...
 * @access  Private
 */
const httpGetOrderStatus = async (req, res) => {
    const { id } = req.params;
    try {
...
exports.httpGetOrderStatus = httpGetOrderStatus;
/**
