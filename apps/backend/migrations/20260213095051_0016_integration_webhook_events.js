export async function up(knex) {
    await knex.schema.createTable('integration_webhook_events', (table) => {
        ...
        table.unique(['shop_id', 'integration', 'external_event_id'], 'integration_webhook_events_unique');
        table.index(['shop_id']);
...
//# sourceMappingURL=20260213095051_0016_integration_webhook_events.js.map