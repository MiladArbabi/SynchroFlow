...
export async function up(knex) {
    await knex.schema.createTable('shopify_products', (table) => {
         ...
         */
        table.unique(['shop_id', 'platform_product_id'], 'shopify_products_shop_platform_unique');
...
//# sourceMappingURL=20260213122131_0025_restore_shopify_products_compat.js.map