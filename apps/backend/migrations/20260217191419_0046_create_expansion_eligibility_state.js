export async function up(knex) {
    await knex.schema.createTable('expansion_eligibility_state', table => {
        ...
        table.index(['eligible'], 'expansion_eligibility_eligible_idx');
    });
}
/**
...
export async function down(knex) {
    await knex.schema.dropTableIfExists('expansion_eligibility_state');
}
//# sourceMappingURL=20260217191419_0046_create_expansion_eligibility_state.js.map