export async function up(knex) {
  ...
  `);
    ...
    await knex.schema.createTable('inventory_movements', (table) => {
        ...
        table.unique(['device_event_id'], 'inventory_movements_device_event_unique');
    });
    await knex.schema.raw(`
...
//# sourceMappingURL=20260214150348_0037_create_inventory_ledger_and_projection.js.map