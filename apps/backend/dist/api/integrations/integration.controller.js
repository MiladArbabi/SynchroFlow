...
exports.triggerManualSync = exports.preFlightCheck = exports.getSyncStatus = exports.handleOAuthCallback = exports.getHumanReadableError = exports.initiateOAuth = exports.normalizeShopDomain = void 0;
...
const initiateOAuth = (req, res) => {
    ...
    const userId = req.user?.userId; // Temporary fix for TypeScript
 ...
 */
const getHumanReadableError = (shopifyError, description) => {
    const errorMap = {
...
const handleOAuthCallback = async (req, res) => {
    ...
    if (error) {
        ...
        const userFriendlyError = (0, exports.getHumanReadableError)(error, error_description || '');
    ...
    try {
        ...
        if (platform === 'shopify') {
            ...
            try {
                await shopify_app_service_1.ShopifyAppService.completePostInstallation(shop, accessToken, userShopId);
