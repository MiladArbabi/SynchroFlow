...
class CanonicalCommerceIngestionService {
    async insertCanonicalOrder(canonicalOrder) {
        // Basic validation
        ...
        try {
            ...
            if (typeof db_1.default.transaction === 'function') {
                await db_1.default.transaction(async (trx) => {
                    await (0, db_1.default)('canonical_orders')
                        .transacting(trx)
                        .insert(orderRow)
                        .onConflict('canonical_order_id')
                        .merge(orderRow);
                    if (lineItems.length > 0) {
                        await (0, db_1.default)('canonical_order_line_items')
                            .transacting(trx)
                            .insert(lineItems)
                ...
                const mockTrx = db_1.default(); // mock returns the chainable instance
                await (0, db_1.default)('canonical_orders')
                    .transacting(mockTrx)
                    .insert(orderRow)
                    .onConflict('canonical_order_id')
...
exports.default = CanonicalCommerceIngestionService;
