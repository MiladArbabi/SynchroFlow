...
router.get('/top-products', auth_middleware_1.authenticateToken, dashboard_controller_1.getTopProducts);
// Endpoint for "Sales by Traffic Source" widget
router.get('/sales-by-traffic-source', auth_middleware_1.authenticateToken, dashboard_controller_1.getSalesByTrafficSource);
