    ...
    if (!existing) {
      ...
      await executor('order_fulfillment_history').insert({
        ...
        event_occurred_at: canonicalEventTime
          ...
          /**
         * DECISION CREATION REMOVED
         * -------------------------
         * Decisions are exclusively generated by reconciliation.
         *
         * This prevents:
         * - duplicate decision writes
         * - non-deterministic execution
         * - divergence between ingestion and domain logic
         *
         * Execution will be triggered by reconciliation pipeline.
         */
