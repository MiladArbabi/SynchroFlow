...
<ArticleAnimation
  src="/animations/order-fulfillment.html"
  title="Animated Shopify order fulfillment workflow"
  caption="A visual walkthrough of how orders move from block check to batch release, pick, pack, and ship."
/>
