...
relatedLinks:
  ...
  - href: "/blog/does-shopify-have-built-in-warehouse-management"
    ...
    description: "What Shopify does natively and where it stops."
---
...
<QuickAnswer>
Inventory drift is the slow accumulation of discrepancies between Shopify's stock count and what is physically in your warehouse. It is caused by unrecorded movements — returns, damaged stock, pick errors, receiving discrepancies. The immediate fix is a reconciliation stock count. The permanent fix is real-time scan-based inventory that records every movement the moment it happens.
</QuickAnswer>
