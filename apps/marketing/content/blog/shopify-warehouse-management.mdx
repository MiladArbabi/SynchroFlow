...
<ArticleImage
  src="hero-warehouse-flow.png"
  alt="Shopify warehouse management gap — what Shopify tracks natively versus what a dedicated warehouse management system provides for SMB merchants"
...
### 3. Barcode and Scan-Driven Operations
...
- Does it connect via Shopify OAuth — not CSV export or manual sync?
- Does it support camera-scan picking and receiving without dedicated barcode hardware?
- Does it provide an immutable event ledger, not just snapshots of current counts?
- Is it designed for 1–10 person warehouse teams, not enterprise operations managers?
- What is the actual setup time — minutes or weeks?
- Does it surface demand intelligence — low stock alerts, restock risk, supplier performance?
- Does it update Shopify inventory in real time from every scan — not on a sync schedule?
