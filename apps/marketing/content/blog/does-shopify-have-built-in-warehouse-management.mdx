...
<ArticleImage
  src="hero-warehouse-flow-1.png"
  alt="Shopify warehouse management gap showing what Shopify does natively versus what a dedicated WMS provides for SMB merchants"
