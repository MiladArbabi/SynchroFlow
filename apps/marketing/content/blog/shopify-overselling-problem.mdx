...
<QuickAnswer>
Shopify overselling happens when your physical stock count falls below what Shopify thinks is available — and a customer orders the difference. The four root causes are disabled inventory tracking, simultaneous order race conditions, app sync delays, and unrecorded warehouse movements. Each has a specific fix.
</QuickAnswer>
