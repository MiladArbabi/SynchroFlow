...
<ArticleImage
  ...
  alt="LaSyncro stock risk dashboard showing real-time inventory levels and overselling risk alerts for Shopify merchants"
  caption="LaSyncro surfaces stock risk before it becomes an oversold order."
  priority={true}
/>
