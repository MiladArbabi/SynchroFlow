...
## Stocky Shutdown Timeline: The Key Dates

The shutdown is not a single event. It has been rolling out in phases, and two of the three dates have already passed:

**July 7, 2025** — Stocky stopped supporting inventory transfers between locations and min/max forecasting. Merchants who relied on those features to trigger reorders or move stock have been working with a stripped-down app for over a year.

**February 2, 2026** — Stocky was removed from the Shopify App Store. No new installations, no reinstalls. If you uninstall it now, you cannot get it back.

**August 31, 2026** — Complete shutdown. The app stops working and all Stocky APIs cease, which means any third-party tools connected to Stocky will break at the same time. Shopify has indicated a period of read-only access to help with the transition, but no workflows will run.

Why is Shopify doing this? It is consolidating inventory management into Shopify Admin's built-in features rather than maintaining a separate app. That works for simple retail stores — but it leaves merchants who used Stocky for purchase orders, forecasting, and receiving workflows without a native replacement for those capabilities.
...
<NumberedH3 n="1" title="Purchase order receiving" />
...
<NumberedH3 n="2" title="Inventory accuracy" />
...
<NumberedH3 n="3" title="Reorder and supplier visibility" />
...
<NumberedH3 n="4" title="Warehouse execution" />
...
Before Stocky becomes unavailable, export any data your team may need later. Purchase order history, product cost information, inventory reports, and stock count records can be exported as CSV files.

One critical exception: supplier records cannot be exported from Stocky at all. Supplier contacts, lead times, minimum order quantities, and payment terms must be documented manually while you can still open the app. After August 31, 2026, any supplier data left inside Stocky is permanently gone.
...
**LaSyncro** — Best for Shopify merchants running their own warehouse who need inventory accuracy, PO receiving, barcode workflows, pick and pack execution, supplier visibility, and operational traceability. For the full picture of where Shopify's native tools stop and a dedicated system becomes necessary, see [where Shopify warehouse management begins](/blog/shopify-warehouse-management) and the [best WMS for Shopify small business comparison](/blog/best-wms-for-shopify-small-business).
