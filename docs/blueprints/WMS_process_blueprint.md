...
| WEB-STOW-UNIT-01 | P1 | 📋 NEXT         | Stow scan surface migrated to accept LSU- barcodes. Unit status updated received → stowed on confirm. current_location_code written to inventory_units. Legacy fallback respected during progressive labelling transition. Blocked on WEB-RECEIVE-UNIT-01 ✅. |
| WEB-PICK-UNIT-01 | P1  | 📋 PLANNED      | Pick scan surface migrated to accept LSU- barcodes. Unit status updated stowed → picked on confirm. Blocked on WEB-STOW-UNIT-01. |
