...
⚠️ Current webapp UI is order-centric (WEB-PACK-01). Intended production UX is ⚠️ Current webapp UI is order-centric (WEB-PACK-01). Intended production UX is item-centric free-scan (WEB-PACK-02). All upstream blockers cleared: WM-34 ✅ WM-38 ✅ WM-46 ✅ WEB-RECEIVE-UNIT-01 ✅ WEB-STOW-UNIT-01 ✅ WEB-PICK-UNIT-01 ✅. WEB-PACK-02 is NEXT.
...
| WEB-PACK-02 | P1      | 📋 NEXT         | Pack UI redesign — item-centric free-scan. Packer scans any LSU- unit barcode, system resolves to order+line item, shows variant image + order context + sibling item thumbnails. Auto-print invoice+label on first scan per order. Invoice barcode scan confirms shipment. Batch auto-completes. Removes Brief, Summary, Order Complete screens. All upstream blockers cleared: WEB-PICK-UNIT-01 ✅. |
